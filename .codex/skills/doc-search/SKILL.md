...
compatibility: Requires MCP server called ref configured in .codex/mcp-config.json.
---
...
MCP server is called ref and it is configured in `.codex/mcp-config.json`.
