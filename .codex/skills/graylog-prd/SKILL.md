...
compatibility: Requires graylog-prd agent (.codex/agents/graylog-prd.agent.md) and graylog-prd MCP server.
---
...
*"Use the graylog-prd agent to complete this task."*
...
## Configuration
- Requires proper authentication via environment variable `GRAYLOG_PRD_TOKEN` is defined in `.codex/.env`
