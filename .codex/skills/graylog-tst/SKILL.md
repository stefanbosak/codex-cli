...
compatibility: Requires graylog-tst agent (.codex/agents/graylog-tst.agent.md) and graylog-tst MCP server.
---
...
## Configuration
- Requires proper authentication via environment variable `GRAYLOG_TST_TOKEN` is defined in `.codex/.env`
