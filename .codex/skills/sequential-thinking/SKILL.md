...
compatibility: Requires MCP server called sequentialthinking configured in .codex/mcp-config.json.
---
...
MCP server is called `sequentialthinking` and is configured in `.codex/mcp-config.json`.
