...
compatibility: Requires MCP server called fetch configured in .codex/mcp-config.json.
---
...
MCP server is called `fetch` and is configured in `.codex/mcp-config.json`.
